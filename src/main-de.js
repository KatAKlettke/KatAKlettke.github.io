...
function activateSkills() {
    document.querySelector('#filter-all-skills span').innerHTML = 'Skills verstecken';
...
function deactivateSkills() {
    document.querySelector('#filter-all-skills > span').innerHTML = 'Skills zeigen';
    skillList.forEach((skill) => {
...
function activateStrengths() {
    document.querySelector('#filter-all-strengths > span').innerHTML = 'Stärken verstecken';
...
function deactivateStrengths() {
    document.querySelector('#filter-all-strengths > span').innerHTML = 'Stärken zeigen';
    strengthList.forEach((strength) => {
...
function activateProjects() {
    document.querySelector('#filter-all-projects > span').innerHTML = 'Projekte verstecken';
...
function deactivateProjects() {
    document.querySelector('#filter-all-projects > span').innerHTML = 'Projekte zeigen';
    projectList.forEach((project) => {
...
function activateInterests() {
    document.querySelector('#filter-all-interests > span').innerHTML = 'Interessen verstecken';
...
function deactivateInterests() {
    document.querySelector('#filter-all-interests > span').innerHTML = 'Interessen zeigen';
    interestList.forEach((interest) => {
...
function updateFilters() {
    if (localStorage.getItem('allIsShown') === 'true') {
        ...
        document.querySelector('#filter-all-text > span').innerHTML = 'Zeigt Alles';
        ...
        document.querySelector('#filter-all-text > span').innerHTML = 'Alles zeigen';
